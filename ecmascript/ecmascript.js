...
function adicao1(num1, num2) {
    return num1 + num2;
}
console.log(adicao(3, 5));
// os dois modos de criar uma função são similares
//arrow
const adicao2 = (num1, num2) => num1 + num2;
...
function contagemRegressiva(inicio = 3, fim = inicio - 4) {
    console.log(inicio);
    while (inicio > fim) {
        inicio--;
        console.log(inicio);
...
function regressivaPar(inicio, fim) {
    console.log(inicio);
    while (inicio > fim) {
        inicio = inicio - 2;
        console.log(inicio);
...
const numbers = [1, 30, 66, 932, 457];
console.log(Math.min(...numbers));
const turmaA = ['Isa', 'Armando', 'João'];
const turmaB = ['Ana', 'Julia', 'Marta'];
const turmaC = [...turmaA, 'Ana', 'Julia', 'Marta'];
...
let propArray = retornaArray(2, 4, 6, 1998, 4398);
console.log(propArray);
console.log(retornaArray(...numbers));
//Spread e Rest - Tuplas
const tuplas = [2, 'abs', false];
function tuplaParamet(a, b, c) {
    console.log(`1) ${a}, ${b}, ${c}`); //parametro por parametro
}
tuplaParamet(...tuplas);
function tuplaParamet2(...params) {
...
const veiculo = ['corola 2.0', 'prata'];
...
// Exercicio 2
function dizerOlaA(nome = 'pessoa') {
